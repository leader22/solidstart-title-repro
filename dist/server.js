...
var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_-f484e496.js"
	},
	{
		type: "script",
		href: "/assets/entry-client-688e06ea.js"
	},
	{
		type: "style",
...
function Scripts() {
  const context = useContext(ServerContext);
  return [createComponent(HydrationScript, {}), ssr(_tmpl$$3), isIslands , createComponent(NoHydration, {
    get children() {
...
const _tmpl$$1 = ["<main", "><!--#-->", "<!--/--><h1>About!</h1></main>"];
function About() {
...
const _tmpl$ = ["<main", "><!--#-->", "<!--/--><h1>Hello world!</h1></main>"];
function Home() {
